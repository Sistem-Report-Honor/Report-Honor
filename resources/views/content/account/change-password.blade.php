                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="current_password" type="password"
                                class="mt-1 w-full lg:max-w-[35vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md form-control @error('current_password') is-invalid @enderror"
                    ...
                    <div>
                        ...
                        <div class="col-md-6">
                            <input id="new_password" type="password"
                                class="mt-1 w-full lg:max-w-[35vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md form-control @error('new_password') is-invalid @enderror"
                    ...
                    <div>
                        ...
                        <div class="col-md-6">
                            <input id="confirm_password" type="password"
                                class="mt-1 w-full lg:max-w-[35vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md form-control @error('confirm_password') is-invalid @enderror"
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '/accout/detail-account';
                        });
                    } else {
