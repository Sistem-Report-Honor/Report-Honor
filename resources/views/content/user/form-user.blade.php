            ...
            <form action="{{ route('post.user') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 text-sm">
                            @foreach ($golongans as $golongan)
                                <label for="golongan{{ $golongan->id }}"
                                    class="inline-flex items-center bg-[#efefef] py-2.5 px-4 rounded-md">
                    ...
                    <div>
                        ...
                        <input class="mt-1 w-full max-w-[55vw] rounded-md border border-gray-500 shadow-sm sm:text-sm"
                            placeholder="NPWP" type="text" id="NPWP" name="NPWP" required />
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-900" for="jabatan">Jabatan Senat</label>
                        <input class="mt-1 w-full max-w-[55vw] rounded-md border border-gray-500 shadow-sm sm:text-sm"
                            placeholder="Jabatan" type="text" id="jabatan" name="jabatan" required />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input class="mt-1 w-full max-w-[55vw] rounded-md border border-gray-500 shadow-sm sm:text-sm"
                            placeholder="No. Rek" type="text" id="no_rek" name="no_rek" required />
                    </div>

                    <div>
                        <label class="block text-xs font-semibold text-gray-900" for="nama_rekening">Nama Rekening</label>
                        <input class="mt-1 w-full max-w-[55vw] rounded-md border border-gray-500 shadow-sm sm:text-sm"
                            placeholder="Nama Rekening" type="text" id="nama_rekening" name="nama_rekening" required />
                    </div>
