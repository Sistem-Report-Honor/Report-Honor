                                ...
                                <div class="mt-4">
                                    @if ($rapat->status == 'prepare')
                                        <form id="start-meeting-form" action="{{ route('mulai', $rapat->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" onclick="confirmStartMeeting(event)" class="w-full flex items-center justify-center gap-2 hover:gap-2.5 rounded-md bg-[#6E2BB1] px-4 py-2 text-xs font-semibold text-white hover:bg-[#8b3ce1] transition-all">
                                    ...
                                    @elseif ($rapat->status == 'mulai')
                                        <form id="end-meeting-form" action="{{ route('selesai', $rapat->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" onclick="confirmEndMeeting(event)" class="w-full flex items-center justify-center gap-2 rounded-md bg-[#c23c44] px-4 py-2 text-xs font-semibold text-white hover:bg-[#d75c5d] transition-all">
