                ...
                <form action="{{ route('hadir', [$rapat->kode_unik, $id_komisi]) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <select id="id_senat" name="id_senat" class="mt-1 w-full lg:max-w-[55vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md py-2 px-2.5" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="Komisi" value="{{ $rapat->komisi->komisi }}" readonly class="mt-1 w-full lg:max-w-[55vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md" required />
                        </div>
                        <div>
                            <label class="block text-sm md:text-md lg:text-md font-semibold text-gray-900">Password</label>
                            <div class="relative">
                                <input class="mt-1 w-full lg:max-w-[55vw] rounded-md border border-gray-500 shadow-sm text-sm md:text-md lg:text-md" placeholder="Password" type="password" id="password" name="password" required />
