...
@section('content')
    <h1 class="text-3xl font-semibold mb-10">Form Absensi</h1>
    ...
    <div class="p-6">
        ...
        @if ($rapat->status == 'mulai')
            <form action="{{ route('hadir', [$rapat->kode_unik, $id_komisi]) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        <label for="id_senat" class="block text-xs font-semibold text-gray-900">Nama</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-900"> Jenis Rapat </label>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input class="mt-1 w-full max-w-[55vw] rounded-md border border-gray-500 shadow-sm sm:text-sm"
                ...
                <div class="mt-12">
                    <button type="submit" class="text-sm inline-block w-full min-w-56 rounded-lg bg-[#6E2BB1] hover:bg-[#8b3ce1] px-5 py-2 font-medium text-white sm:w-auto transition-all">
                        {{ __('Submit') }}
                    </button>
                </div>
            </form>
