<nav x-data="{ open: false }" class="bg-[#915CC7] text-white border-b border-gray-100">
                                ...
                                <ul class="py-2 text-sm text-gray-700 capitalize" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="{{ route('table.user') }}"
                                            class="block px-4 py-2 hover:bg-gray-100">User List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('form.user') }}"
                                            class="block px-4 py-2 hover:bg-gray-100">User Create</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="py-2 text-sm text-gray-700 capitalize" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="{{ route('list.rapat') }}"
                                            class="block px-4 py-2 hover:bg-gray-100">Rapat List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('form.rapat') }}"
                                            class="block px-4 py-2 hover:bg-gray-100">Rapat Create</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pb-1">
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary
                    class="flex cursor-pointer items-center justify-between rounded-lg text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                    <div class="px-4">
                        <div class="font-normal text-base text-white">{{ Auth::user()->name }}</div>
                    </div>
