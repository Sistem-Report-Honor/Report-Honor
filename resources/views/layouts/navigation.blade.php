        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden md:flex lg:flex items-center md:order-2 space-x-3 md:space-x-0">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow min-w-52" id="user-dropdown">
                    <div class="py-3">
                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownProfil" class="flex items-center justify-between text-sm w-full font-normal py-2 px-4 text-gray-700 hover:bg-gray-100">
                            <span class="block text-sm text-gray-900">{{ Auth::user()->name }} <br> <span class="block text-sm  text-gray-500 truncate">{{ Auth::user()->username }}</span></span>
                            <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg></button>
                        <!-- Dropdown menu -->
                        <div id="dropdownProfil" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="{{ route('account.detail') }}" class="block px-4 py-2 hover:bg-gray-100">Informasi Profil</a>
                                </li>
                                <li>
                                    <a href="{{ route('change.password') }}" class="block px-4 py-2 hover:bg-gray-100">Ubah Password</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home</a>
                        </li>
                        @if (Auth::user()->hasRole('admin'))
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownRapat" class="flex items-center justify-between text-sm w-full font-normal py-2 px-4 text-gray-700 hover:bg-gray-100">Rapat
                                <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                </svg></button>
                            <!-- Dropdown menu -->
                            <div id="dropdownRapat" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="{{ route('list.rapat') }}" class="block px-4 py-2 hover:bg-gray-100">Daftar Rapat</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('form.rapat') }}" class="block px-4 py-2 hover:bg-gray-100">Tambah Rapat</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownReport" class="flex items-center justify-between text-sm w-full font-normal py-2 px-4 text-gray-700 hover:bg-gray-100">Laporan
                                <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                </svg></button>
                            <!-- Dropdown menu -->
                            <div id="dropdownReport" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="{{ route('list.honor.detail') }}" class="block px-4 py-2 hover:bg-gray-100">Laporan Honor Bulanan</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('list.honor.dasar') }}" class="block px-4 py-2 hover:bg-gray-100">Laporan Honor Dasar</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownUser" class="flex items-center justify-between text-sm w-full font-normal py-2 px-4 text-gray-700 hover:bg-gray-100">User
                                <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                </svg></button>
                            <!-- Dropdown menu -->
                            <div id="dropdownUser" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="{{ route('table.user') }}" class="block px-4 py-2 hover:bg-gray-100">Daftar User</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('form.user') }}" class="block px-4 py-2 hover:bg-gray-100">Tambah User</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <a href="{{ route('golongan.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Golongan</a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{ route('list.honor.dasar.pribadi') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Honor</a>
                        </li>
                        @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-white hover:bg-white/10">
